  ...
  let language =
    List.find_map
      (fun (language, _quality) ->
         try Some (I18n.guess_language_of_string language) with _ -> None)
      (Eliom_request_info.get_accept_language ())
  in
  Option.iter I18n.set_language language;
  ignore [%client (Option.iter I18n.set_language ~%language : unit)]
